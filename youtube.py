api_key = 'AIzaSyD45960SpJU7_dpZxXbaNrGf5ky_GXVuTw' 
...
eta = psycopg2.connect(host='localhost', user='postgres', password='Arun008@',port=5432,database='guvi')
cursor=eta.cursor()
...
omega=pymongo.MongoClient("mongodb+srv://arunprakash:Arun008@cluster0.hy5hlc5.mongodb.net/?retryWrites=true&w=majority")#enter the connection link from mongodb
